 ...
 * and then inject into your aspect, use the annotation [AspectModuleLink], and instead return null from [module]. This has the drawback/benefit of your aspect being
